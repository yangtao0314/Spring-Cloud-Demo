...
public class SendEmailUtil {
    ...
    static String FROM = "18032110537@163.com"; // 发件人地址
    static String TO = "675821215@qq.com"; // 收件人地址
    static String AFFIX = ""; // 附件地址
    static String AFFIXNAME = ""; // 附件名称
    static String USER = "18032110537@163.com"; // 用户名
    static String PWD = "a59669258***"; // 163的授权码
    static String SUBJECT = "欢迎光临"; // 邮件标题
